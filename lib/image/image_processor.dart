...
import 'package:f_rali_vision/common/sequential_processor.dart';
import 'package:f_rali_vision/common/support_preconditions.dart';
import 'package:f_rali_vision/common/tensor_operator.dart';
import 'package:f_rali_vision/image/ops/tensor_operator_wrapper.dart';
...
class ImageProcessorBuilder extends SequentialProcessorBuilder<TensorImage> {
  ...
  ImageProcessorBuilder add(Operator op) {
    if (op is ImageOperator) {
      ...
      return add(TensorOperatorWrapper(op));
    } else {
